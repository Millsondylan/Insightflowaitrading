 ...
 */
export function isAnswerCorrect(question: Question, answer: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any): boolean {
