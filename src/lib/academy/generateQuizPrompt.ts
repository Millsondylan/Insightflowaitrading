...
export function validateQuizResponse(aiResponse: string): Quiz {
  try {
    ...
    let quizData: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any;
    ...
    quizData.questions.forEach((q: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any, index: number) => {
      ...
      if (q.type === 'multiple-choice') {
        ...
        q.pairs.forEach((pair: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any) => {
