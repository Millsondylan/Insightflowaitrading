...
export class EventProcessor {
  ...
  private checkAlertThresholds(metrics: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any): void {
