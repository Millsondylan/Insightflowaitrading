...
export async function updateAIPreferences(userId: string, preferences: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any) {
  return await supabase
    .from('user_profiles')
