...
export interface AcademyCourse {
  ...
  learning_objectives: any // eslint-disable-line @typescript-eslint/no-explicit-any[];
...
export interface AcademyProgress {
  ...
  quiz_answers: any // eslint-disable-line @typescript-eslint/no-explicit-any[];
...
function getCategoryFromCourse(course: any // eslint-disable-line @typescript-eslint/no-explicit-any): string {
...
function extractCourseTypes(course: any // eslint-disable-line @typescript-eslint/no-explicit-any): string[] {
  const types = [];
...
function extractTags(course: any // eslint-disable-line @typescript-eslint/no-explicit-any): string[] {
