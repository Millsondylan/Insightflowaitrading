...
export const TradeAnalyzer: React.FC<Tradeanalyzerprops> = ({
  ...
  return (
   ...
   >
        ...
        {/* Trade Rating */}
        <Div className="mb-6">
          <Label className="block mb-1 font-medium"></Textarea></Textarea></Textarea></Textarea></Div>Trade Execution Rating (1-5)</Div>
          <Div className="flex space-x-2">
            {[1, 2, 3, 4, 5].map((rating) => (
              <Button key={rating}
                ...
                onClick={() =></Div></Div></Div></Div> handleRatingChange(rating)}
              >
                {rating}
              </Div>
            ))}
        ...
        <Div className="flex justify-end">
          <Button className="px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primary/80 disabled:opacity-50"
            ...
            disabled={isSaving}></Div></Div></Div></Div>
