...
export class MonteCarloSimulator {
   ...
   */
  private async simulateScenario(params: any // eslint-disable-line @typescript-eslint/no-explicit-any, scenarioId: number): Promise<ScenarioResult></ScenarioResult> {
