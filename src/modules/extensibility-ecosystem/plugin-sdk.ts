...
export class PluginLoader {
   ...
   */
  async executeHook(hookName: string, ...args: any // eslint-disable-line @typescript-eslint/no-explicit-any[]): Promise<any> {
...
export const createPluginContext = (
  ...
  platform: any // eslint-disable-line @typescript-eslint/no-explicit-any, 
