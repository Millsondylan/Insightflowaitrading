...
export const calculateStrategyScore = (performance: any // eslint-disable-line @typescript-eslint/no-explicit-any) => {
...
export const filterStrategiesByRisk = (strategies: any // eslint-disable-line @typescript-eslint/no-explicit-any[], riskLevel: string) => {
  return strategies.filter(strategy => strategy.risk === riskLevel);
}

export const sortStrategiesByPerformance = (strategies: any // eslint-disable-line @typescript-eslint/no-explicit-any[], metric: string = 'winRate') => {
