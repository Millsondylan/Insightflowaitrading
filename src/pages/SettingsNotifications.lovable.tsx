    ...
    <Section className="theme-notify min-h-screen px-6 py-16 space-y-12">
      ...
      <Div className="space-y-8 animate-in fade-in slide-up" style={{ animationDelay: '100ms' }}>
        <Div className="glass-section motion-shadow">
          <H2 className="text-2xl font-bold text-orange-400 mb-6">📱 Push Notifications</Div>
        ...
        <Div className="glass-section motion-shadow">
          <H2 className="text-2xl font-bold text-yellow-400 mb-6">📧 Email Notifications</Div>
          <Div className="space-y-4">
            <Div className="glass-card">
              <Div className="flex justify-between items-center">
                <Div>
      ...
      <Div className="glass-section motion-shadow animate-in fade-in slide-up" style={{ animationDelay: '200ms' }}>
        <H2 className="text-2xl font-bold text-white mb-6">⏰ Notification Frequency</Div>
