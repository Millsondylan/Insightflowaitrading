  ...
  return (
    <Section className="theme-strategy min-h-screen px-6 py-16 space-y-12">
      ...
      <Div className="glass-section motion-shadow animate-in fade-in slide-up" style={{ animationDelay: '100ms' }}>
        <H2 className="text-3xl font-bold text-white mb-8"></Div></Div>📤 Export Formats</Div>
        <Div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Div className="glass-card hover-glow text-center">
            ...
            <P className="text-gray-300 text-sm mb-4">Comprehensive strategy documentation</P>
                          <Button className="glow-button glow-cyan px-4 py-2 text-sm"></Button>
                Export PDF
              </Button>
          </Div>
          <Div className="glass-card hover-glow text-center">
            ...
            <P className="text-gray-300 text-sm mb-4">Data analysis and calculations</P>
                          <Button className="glow-button glow-blue px-4 py-2 text-sm"></Button>
                Export Excel
              </Button>
          </Div>
          <Div className="glass-card hover-glow text-center">
            ...
            <P className="text-gray-300 text-sm mb-4">Machine-readable format</P>
                          <Button className="glow-button glow-teal px-4 py-2 text-sm"></Button>
                Export JSON
              </Button>
          </Div>
        </Div>
      ...
      <Div className="glass-section motion-shadow animate-in fade-in slide-up" style={{ animationDelay: '200ms' }}>
        <H2 className="text-3xl font-bold text-white mb-6"></Div></Div>⚙️ Export Settings</Div>
        <Div className="space-y-4">
          <Div className="glass-card">
            <Div className="flex justify-between items-center">
              <Span className="text-gray-300"></Div></Div>Include Backtest Results</Div>
              <Div className="w-12 h-6 bg-cyan-500/20 rounded-full border border-cyan-400/30"></Div>
            </Div>
          </Div>
          <Div className="glass-card">
            <Div className="flex justify-between items-center">
              <Span className="text-gray-300"></Div></Div>Include Risk Metrics</Div>
              <Div className="w-12 h-6 bg-cyan-500/20 rounded-full border border-cyan-400/30"></Div>
            </Div>
          </Div>
          <Div className="glass-card">
            <Div className="flex justify-between items-center">
              <Span className="text-gray-300"></Div></Div>Include Charts</Div>
              <Div className="w-12 h-6 bg-cyan-500/20 rounded-full border border-cyan-400/30"></Div>
            </Div>
          </Div>
        </Div>
