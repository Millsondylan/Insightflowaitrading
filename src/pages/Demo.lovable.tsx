    ...
    <Div className="theme-strategy min-h-screen px-6 py-20">
      <Div className="max-w-4xl mx-auto">
        <Div className="text-center mb-12">
          <H1 className="text-4xl md:text-6xl font-bold text-glow-cyan mb-4"></Div></Div>
        ...
        <Div className="mb-8 glass-section p-4">
          <H2 className="text-2xl font-semibold text-cyan-300 mb-4"></Div></Div>🧪 Try these examples:</Div>
          <Div className="grid md:grid-cols-2 gap-4 text-gray-300">
            <Div className="space-y-2">
              <H3 className="text-white font-medium"></Div></Div>Breakout Strategy:</Div>
              <P className="text-sm">Type "breakout" to see momentum strategy with volume suggestions</P>
            </Div>
            <Div className="space-y-2">
              <H3 className="text-white font-medium"></Div></Div>RSI Strategy:</Div>
              <P className="text-sm">Type "RSI divergence" for oscillator-based strategy</P>
            </Div>
            <Div className="space-y-2">
              <H3 className="text-white font-medium"></Div></Div>EMA Strategy:</Div>
              <P className="text-sm">Type anything else for moving average pullback strategy</P>
            </Div>
            <Div className="space-y-2">
              <H3 className="text-white font-medium"></Div></Div>Risk Warnings:</Div>
