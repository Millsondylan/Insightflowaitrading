    ...
    <Div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
      ...
      <Div className="lg:col-span-1 space-y-6">
        <Div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
            ...
            />
            <Button  style={{ width: "100%" }}>Save Entry</Textarea>
        </Div>
        ...
        <Div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
            ...
            <Link to="/coach">
                <Button variant="outline" style={{ width: "100%" }}>Ask for a Review</Link>
            </Link>
        </Div>
        ...
        <Div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
            ...
            <Link to="/feed">
                <Button variant="outline" style={{ width: "100%" }}>View Your Feed</Link>
            </Link>
        </Div>
      </Div>
    </Div>
