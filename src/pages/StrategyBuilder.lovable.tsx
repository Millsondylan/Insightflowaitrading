  ...
  return (
    <Div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
      ...
      <Div className="lg:col-span-2 space-y-8">
        ...
        {/* Generated Output */}
        <Div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
            <H3 className="font-semibold text-white mb-3 flex items-center gap-2"></Div></Div>
                <filetext >
      ...
      <Div className="lg:col-span-1 bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm space-y-6">
        <H2 className="text-xl font-bold text-white"></Div></Div>Configuration</Div>
        ...
        <configitem title="Next Steps">
            <Div className="flex flex-col gap-3">
                <Link to="/planner">
                    <Button variant="outline" style={{ width: "100%" }}></Div></Div>Create Trading Plan</Div>
                </Link>
                <Link to="/vault">
