  ...
  return (
    <Section className="theme-help min-h-screen px-6 py-16 space-y-12">
      ...
      <Div className="glass-section motion-shadow animate-in fade-in slide-up" style={{ animationDelay: '200ms' }}>
        <H2 className="text-3xl font-bold text-white mb-8">❓ Frequently Asked Questions</Div>
        <Div className="space-y-4">
          <Div className="glass-card">
            <H4 className="font-semibold text-indigo-400 mb-2">How do I create my first strategy?</Div>
          ...
          <Div className="glass-card">
            <H4 className="font-semibold text-purple-400 mb-2">Can I backtest my strategies?</Div>
            <P className="text-gray-300 text-sm">Yes! Use the Backtest feature to test your strategies against historical market data.</P>
          </Div>
          <Div className="glass-card">
            <H4 className="font-semibold text-blue-400 mb-2">How does the journal feature work?</Div>
      ...
      <Div className="glass-section motion-shadow animate-in fade-in slide-up" style={{ animationDelay: '300ms' }}>
        <H2 className="text-3xl font-bold text-white mb-6 text-center">💬 Contact Support</Div>
        <Div className="max-w-md mx-auto text-center">
          <P className="text-gray-300 mb-6">Can't find what you're looking for? Our support team is here to help.</Div>
