...
jest.mock('@/integrations/supabase/client', () => {
  const rows: any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any // eslint-disable-line @typescript-eslint/no-explicit-any[] = [{ schema: { type: 'object', properties: { foo: { type: 'string' } }, required: ['foo'] } }];
  return {
    supabase: {
      from: () => ({
